/********************************************************************************************************
 * @file    board_b95_dongle.h
 *
 * @brief   This is the header file for board_b95_dongle
 *
 * @author  Zigbee Group
 * @date    2023
 *
...
#define GPIO_SYSTIME 		GPIO_PB7
#define GPIO_MODE			GPIO_PB6
#define GPIO_FLASH_ERAES 	GPIO_PB5
#define GPIO_RF_IRQ			GPIO_PB3
